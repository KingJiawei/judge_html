...
class ExtractByKeywordYara:
    def __init__(self):
        self.unigram_keyword_file = "keyword.yar"
        self.trigram_keyword_file = "/home/jiawei/judge_html/test_tfidf/tfidf.yar"
        self.keyword_file = "total.yar"
        self.feature_list = []
        self.feature_dict = {}
        self.html_pattern_list = []

        self.no_html_feature_file = "/home/jiawei/judge_html/test_keyword_by_yara/trigram/no_html_feature_file.txt"
        self.html_feature_file = "/home/jiawei/judge_html/test_keyword_by_yara/trigram/html_feature_file.txt"
        ...
        self.train_file_path = "/home/jiawei/judge_html/test_keyword_by_yara/trigram/"
        self.test_file_path = "/home/jiawei/judge_html/test_keyword_by_yara/trigram/"
    ...
    def analyze_content(self, content):
        ...
        for matched in matched_rules:
            ...
            if matched.rule.startswith('tfidf_'):
                index_value = matched.meta['index']
                self.matched_feature_index_map_[int(index_value)+820] = 1
            index_value = matched.meta['index']
    ...
    def train_and_score(self):
        ...
        threshold = self.compute_threshold(self.html_num,self.no_html_num)
    ...
    def merge_yara_file(self):
        os.system("cat {} > {}".format(self.unigram_keyword_file,self.keyword_file))
        os.system("cat {} >> {}".format(self.trigram_keyword_file,self.keyword_file))
        self.yara_rules_ = yara.compile(self.keyword_file)

    def start(self):
        self.merge_yara_file()
        print "dump {}".format(self.html_sample_path)
        self.html_num = self.dump_feature(1, self.html_sample_path, self.html_feature_file)
        print "dump {}".format(self.no_html_sample_path)
        self.no_html_num = self.dump_feature(0, self.no_html_sample_path, self.no_html_feature_file)
        print "html num is {},no html num is {}".format(self.html_num,self.no_html_num)
        self.split_file()
