...
class ExtractByKeywordYara:
    def __init__(self):
        ...
        self.no_html_tfidf_feature_file = "/home/jiawei/judge_html/test_tfidf/no_html_tfidf_feature_file.txt"
        self.html_tfidf_feature_file = "/home/jiawei/judge_html/test_tfidf/html_tfidf_feature_file.txt"
        self.total_tfidf_feature_file = "/home/jiawei/judge_html/test_tfidf/total_tfidf_feature_file.txt"
        ...
        self.n_top_words = 300
        self.tfidf_base_index = 0
        self.file_index = 0
    ...
    def select_feature(self, train_file, result_dir):
        ...
        with open("log.txt", 'wb') as log_open:
            ...
            for key in vocabulary_dict.keys():
                try:
                    log_open.write(key.decode('ascii', 'replace'))
                    log_open.write("\n")
    ...
    def extract_tfidf_keyword(self):
        self.vectorizer = TfidfVectorizer(input='content', decode_error='ignore', max_features=1000, ngram_range=(1, 3),
            ...
            for file_path in self.corpus[:self.html_num]:
                try:
                    ...
                    for j in range(0, self.n_top_words):
                        tfidf_dict[self.tfidf_base_index + self.indices[j]] = self.tfidf_array_float[self.file_index,j]
                    self.file_index += 1
                    features = tfidf_dict
