...
class UseDoc2vec:
    def __init__(self,data):
        ...
        self.test_file = "0a2e196b9fe12ca604d44f94890874fbf0d0648d"
    ...
    def train_doc2vec_model(self):
        self.model = gensim.models.Doc2Vec(size=self.doc2vec_size, min_count=3, iter=200, workers=100)
    ...
    def start(self):
        self.doc2vec_size = self.data
        iter_str = str(self.data)
