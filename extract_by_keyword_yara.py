...
class ExtractByKeywordYara:
    def __init__(self):
        ...
        self.train_file_path = "/home/jiawei/judge_html/test_keyword_by_yara/"
        ...
        self.predict_feature_file = "/home/jiawei/judge_html/test_keyword_by_yara/predict_feature_file.txt"
    ...
    def start(self):
        ...
        print "threshold is {}".format(self.compute_threshold(self.html_num,self.no_html_num))
        self.split_file()
    ...
    def predict(self,dst_path):
        print "dump {}".format(dst_path)
        self.dump_feature(1, dst_path, self.predict_feature_file)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        extract_by_keyword_yar.predict(sys.argv[1])